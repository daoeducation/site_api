...
argglobal
%argdel
edit migrations/20210922082103_initial.sql
...
set winminwidth=0
set winwidth=1
exe '1resize ' . ((&lines * 32 + 20) / 41)
exe 'vert 1resize ' . ((&columns * 98 + 71) / 143)
exe '2resize ' . ((&lines * 6 + 20) / 41)
exe 'vert 2resize ' . ((&columns * 98 + 71) / 143)
exe 'vert 3resize ' . ((&columns * 44 + 71) / 143)
argglobal
terminal ++curwin ++cols=98 ++rows=32 
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
if bufexists("src/models/mod.rs") | buffer src/models/mod.rs | else | edit src/models/mod.rs | endif
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 428 - ((20 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
428
...
tabnext 1
badd +97 src/main.rs
badd +752 src/models/mod.rs
badd +6 src/controllers/payments.rs
badd +108 src/test_support.rs
badd +6 src/controllers/students.rs
badd +28 migrations/20210922082103_initial.sql
badd +72 src/error.rs
badd +468 ~/flocksom/constata_lib/src/models/document.rs
